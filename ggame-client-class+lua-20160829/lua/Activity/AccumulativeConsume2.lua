...
local thisPageName = "AccumulativeConsume2"

local opcodes = {
	ACC_CONSUME_INFO_C 		= HP_pb.ACC_CONSUME2_INFO_C,
	ACC_CONSUME_INFO_S		= HP_pb.ACC_CONSUME2_INFO_S,
	GET_ACC_CONSUME_AWARD_C	= HP_pb.GET_ACC_CONSUME2_AWARD_C,
	GET_ACC_CONSUME_AWARD_S	= HP_pb.GET_ACC_CONSUME2_AWARD_S
};
local option = {
...
AccumulativeConsume2 = CommonPage.newSub(AccumulativeConsumeBase, thisPageName, option);
