...
local thisPageName = "DailyOnceRecharge2"

local opcodes = {
	DAILY_RECHARGE_INFO_C 		= HP_pb.SINGLE_RECHARGE2_INFO_C,
	DAILY_RECHARGE_INFO_S		= HP_pb.SINGLE_RECHARGE2_INFO_S,
	GET_DAILY_RECHARGE_AWARD_C	= HP_pb.SINGLE_RECHARGE2_AWARD_C,
	GET_DAILY_RECHARGE_AWARD_S	= HP_pb.SINGLE_RECHARGE2_AWARD_S
};
local option = {
...
DailyOnceRecharge2 = CommonPage.newSub(DailyOnceRechargeBase, thisPageName, option);
