#ifndef GuildThiefDefScene_h__
#define GuildThiefDefScene_h__
...
class CGuildThiefDefScene : public CBaseFightScene
{
public:
	CGuildThiefDefScene();
	virtual ~CGuildThiefDefScene();

	CREATE_FUNC(CGuildThiefDefScene);
