...
int CBattleDefRatioCfgMaster::ValidateCfg()const
{
    int iRet = 0;
    ...
    {
        unsigned int uiCfgID = m_stCfg.battlecfg(iIdx).atktype() * 10000 + m_stCfg.battlecfg(iIdx).armortype() * 100;
...
int CBattleDefRatioCfgMaster::SetCfg()
{
    int iRet = 0;
...
BattleDefRatioCfg* CBattleDefRatioCfgMaster::GetBattleDefRatioCfgByID(const unsigned int uiCfgID)
{
